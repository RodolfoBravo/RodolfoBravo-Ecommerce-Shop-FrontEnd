                    ...
                    <div className="offcanvas offcanvas-end text-white bg-dark" tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
                        ...
                        <div className="offcanvas-body">
                            <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                                <li className={this.getNavLinkClass("/")}><NavLink className='nav-link' to="/" >Home
                                </NavLink></li>

                                <li className={this.getNavLinkClass("/About")}><NavLink className='nav-link' to="/About" >
                                    About
                                </NavLink></li>

                                <li className={'nav-item' + ' ' + this.getNavLinkClass("/Shop")}><NavLink className='nav-link' to="/Shop" >
                                    Shop
                                </NavLink></li>

                                <li className={'nav-item' + ' ' + this.getNavLinkClass("/Help")}><NavLink className='nav-link' to="/Help" >
                                    Help
                                </NavLink></li>
